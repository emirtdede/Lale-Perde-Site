...
const defaultCategories = [
  { 
    ...
    images: ['/assets/scandi.png', '/assets/fabric.png', '/assets/hero.png'],
    status: 'active', 
    display_order: 1,
  ...
  { 
    ...
    images: ['/assets/hero.png', '/assets/scandi.png', '/assets/fabric.png'],
    status: 'active', 
    display_order: 2,
  ...
  { 
    ...
    images: ['/assets/fabric.png', '/assets/scandi.png', '/assets/hero.png'],
    status: 'active', 
    display_order: 3,
  ...
  { 
    ...
    image: '/assets/hero.png', 
    images: ['/assets/hero.png', '/assets/fabric.png', '/assets/scandi.png'],
    status: 'active', 
    display_order: 4,
